...
CREATE TABLE IF NOT EXISTS `ping-pong`.`tournament` (
  ...
  PRIMARY KEY (`id`) ,
  INDEX `fk_tournament_user_idx` (`promoter_id`),
...
CREATE TABLE IF NOT EXISTS `ping-pong`.`tournament_user` (
  ...
  INDEX `fk_tournament_user_user_idx` (`user_id`),
  INDEX `fk_tournament_user_tournament_idx` (`tournament_id`),
